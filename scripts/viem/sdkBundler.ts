import { createClient, http, formatUnits } from "viem";
import fs from "fs";
...
/**
 * Initializes the client and liquidity loader for a specific chain
 * @param chainId - The blockchain network identifier
 * @returns Object containing initialized client, chain configuration, and liquidity loader
...
async function initializeClientAndLoader(chainId: number) {
  ...
  return { client, config, loader: new LiquidityLoader(client) };
}
...
// Example usage
const marketId =
  "0xc84cdb5a63207d8c2e7251f758a435c6bd10b4eaefdaf36d7650159bf035962e" as MarketId;
const chainId = 1;
const REQUESTED_LIQUIDITY = BigInt("24000000000000000000000000");

const decimals = 18; // only for display
const priceUsd = 1; // only for display
